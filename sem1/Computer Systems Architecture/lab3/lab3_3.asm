...
segment code use32 class=code
    ...
    ;(a*b-2*c*d)/(c-e)
        ...
        mov al, [a] ; AL = [a] = 4
        mul byte [b] ; AX = AL * [b] = 4 * 6 =24
        
        push word ax ; top stack byte = AX = 24
        
        mov al, 2 ; AL = 2
        mul byte [c] ; AX = 2 * [c] = 2 * 2 = 4
    ...
    ;x/a    
        ...
        div ebx ; EAX = EDX:EAX / EBX = 16 / 4 = 4
     ...
     ;(a*b-2*c*d)/(c-e)+x/a
        ...
        add eax, ebx ; EAX = EAX - EBX = 12 + 4 = 16
